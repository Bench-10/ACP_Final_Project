...
label = Label(root, text="Registration System", font=('Ink Free', 60 ))
label.grid(row=0, column=0, columnspan=8, rowspan=2, padx=50, pady=40)

studidLabel = Label(root, text="Student ID", font=('Consolas', 17))
fnameLabel = Label(root, text="FirstName", font=('Consolas', 17))
lnameLabel = Label(root, text="LastName", font=('Consolas', 17))
addressLabel = Label(root, text="Address", font=('Consolas', 17))
phoneLabel = Label(root, text="Phone No.", font=('Consolas', 17))
